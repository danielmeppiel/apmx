...
| --- | --- |
| COMPLETE / 0 | Current v0.4.2 source and downloads: all declared work/checks and retained evidence completed and finalized; not isolation or trust. |
...
Current v0.4.2 source and downloads return COMPLETE/0 only for complete
