...
class DependencyReference(ProviderCoordinateMixin):
    ...
    def ref_kind(self) -> str | None:
        ...
        * ``"semver"`` -- ``reference`` parses as a valid semver range
          ...
          :class:`~apmx.deps.git_semver_resolver.GitSemverResolver`.
    ...
    def _check_no_embedded_subpath(url: str, *, host_type: str | None = None) -> None:
        ...
        if host is None:
            return
        from apmx.core.host_providers import classify_host_provider
    ...
    def _parse_host_type(raw: object) -> str | None:
        ...
        from apmx.core.host_providers import accepted_host_types
    ...
    def _bare_shorthand_repo_segment_count(cls, path_segments: list[str]) -> int:
        ...
        boundary probe in :mod:`apmx.install.artifactory_resolver` can
    ...
    def _parse_registry_object_entry(cls, entry: dict) -> "DependencyReference":
        ...
        raise ValueError("Registry dependencies are unsupported by standalone contracts.")
